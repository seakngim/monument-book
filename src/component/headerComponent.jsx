    ...
    <Popover className="bg-white shadow-md sticky top-0 z-10 max-w-full text-white ">
      <div className="flex justify-between gap-5 items-center w-[80%] m-auto h-20">
        ...
        <div className="flex items-center justify-end py-5 gap-5 ">
          ...
          {localStorage.getItem("token") ? (
                ...
                items: [
                  {
                    ...
                    key: "1",
                    icon: <FiUser style={{ fontSize: "16px", color: "#292D77" }} />,
                  },
                  {
                    type: "divider",
                  },
                  {
                    ...
                    key: "2",
                    icon: <HiOutlineShoppingCart style={{ fontSize: "16px", color: "#292D77" }} />,
                  },
                  {
                    type: "divider",
                  },
                  {
                    ...
                    key: "3",
                    icon: <FiShoppingBag style={{ fontSize: "16px", color: "#292D77" }} />,
                  },
                  {
                    type: "divider",
                  },
                  {
                    ...
                    key: "4",
                    icon: <FiHeart style={{ fontSize: "16px", color: "#292D77" }} />,
                  },
                  {
                    type: "divider",
                  },
                  {
                    label: <><p type="primary" onClick={showModal}>
                      Sign out
                    </p>
                    </>,
                    key: "2",
                    icon: <FiLogOut style={{ fontSize: "16px", color: "#292D77" }} />
                  },
            ...
            >
              <a onClick={(e) => e.preventDefault()}>
                <AppstoreOutlined style={{ fontSize: "20px", color: "#292D77" }} />
              </a>
            </Dropdown>
          ) : (
          ...
          {localStorage.getItem("token") && localStorage.getItem("user_role") == "ADMIN" ? (
            <>
      ...
      <Modal
        ...
        footer={[
          <button key="cancel" className="border border-[#292D77] text-[#292D77] px-5 py-1 rounded-md hover:bg-[#292D77] hover:text-gray-50 duration-500 mr-2" onClick={handleCancel}>Cancel</button>,
          <button key="ok" className="border border-red-500 bg-red-500 text-red-50 px-5 py-1 rounded-md hover:bg-red-600 duration-500" onClick={handleOk}>Ok</button>
        ]}
      >
