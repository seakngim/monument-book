...
const CreateNewComponent = (props) => {
    ...
    return (
        <>
            ...
            <Form layout="vertical" onFinish={onFinish} className="shadow-lg rounded-lg p-5 pt-2 pb-10">
                <Divider className="text-red-800 text-3xl" orientation="left">Create New Book </Divider>
