...
import { Breadcrumb, Button, Card, InputNumber, Select } from "antd";
...
const CartComponent = () => {
  ...
  const handleBuy = () => {
    BookService.buyservice(combinedArray).then((res) => {
  ...
  return (
    <div className="w-[80%] m-auto">
      ...
      <div className="flex text-left border-b pb-3 border-gray-400">
        <p className="text-lg font-bold text-[#292D77] dark:text-[#292D77]">Shopping Cart</p>
      </div>
