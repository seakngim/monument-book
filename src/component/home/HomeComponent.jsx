...
const HomeComponent = () => {
  ...
  return (
    <>
                    ...
                    <section className="text-white grid md:grid-cols-2 mb-20">
                      ...
                      <div className="mx-5 mt-5 lg:mx-0">
                        ...
                        <p className="mt-2 flex gap-1 md:mb-0 text-[3.2vw] md:text-[2vw] xl:text-[1.75rem] text-gray-400">
                          Author:{" "}
                          <span className="line-clamp-1 ml-5">{book.author}</span>
                        </p>
      ...
      {/* Feature */}
      <section>
        <h1 className="text-center text-[#2BD7AD] font-bold text-2xl sm:text-4xl md:text-4xl lg:text-[3.75rem] lg:py-20">Feature</h1>
      ...
      <section id="best-selling">
        ...
        <div className="background-gradient py-20 ">
          <div className="w-[80%] mx-auto px-[5px] grid xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-6 mb-5">
      ...
      <section id="new-arrivals">
        ...
        <div className="">
          <div className="w-[80%] mx-auto grid xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-6 mb-5">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <Link to="/author" >
                    <img
                      ...
                      alt="Author"
                    />
                    <p className="w-96 h-auto m-auto rounded-lg hover:opacity-90 p-2 py-2">{item.authorquote}</p>
                  </Link>
      ...
      <section id="our-activities">
        ...
        <div className="pb-10">
          <div className="w-[80%] grid xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-6 mb-5 mx-auto">
            {news.length > 0 ? (
              news.map((news) => (
                <CardOurActivites
                  key={news.id}
